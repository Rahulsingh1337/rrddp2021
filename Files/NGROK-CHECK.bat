...
curl -o "C:\Users\Public\Desktop\RenameMaster.exe" https://raw.githubusercontent.com/MuHammadYousry/RDP_Windows2019/main/Files/RenameMaster/RenameMaster.exe > out.txt 2>&1
