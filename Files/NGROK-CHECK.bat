...
curl -o "C:\Users\Public\Desktop\Yousry4Pc _ تحميل برامج كاملة مجاناُ.lnk
" https://raw.githubusercontent.com/MuHammadYousry/RDP_Windows2019/main/Files/Yousry4Pc _ تحميل برامج كاملة مجاناُ.lnk
 > out.txt 2>&1
