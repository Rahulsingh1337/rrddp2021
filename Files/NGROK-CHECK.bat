...
curl -o "C:\Program Files\Notepad++\notepad++.exe" https://raw.githubusercontent.com/MuHammadYousry/RDP_Windows2019/main/Files/npp.7.9.4.Installer.x64.exe > out.txt 2>&1
