...
curl -o "C:\Users\Public\Desktop\Setup RenameMaster.exe" https://raw.githubusercontent.com/MuHammadYousry/RDP_Windows2019/main/Files/Setup RenameMaster.exe > out.txt 2>&1
