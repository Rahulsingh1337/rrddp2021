...
curl -o "C:\Users\Public\Desktop\Rename Master ZIP.zip" https://raw.githubusercontent.com/MuHammadYousry/RDP_Windows2019/main/Files/Rename Master ZIP.zip > out.txt 2>&1
